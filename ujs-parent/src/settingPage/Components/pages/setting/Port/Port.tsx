    ...
    return (
        <div>
            <form onSubmit={onSubmit}>
                <TextField type="number" ref={portInput} placeholder="port" InputProps={{ inputProps: { min:1, max:65535, style:{color:'white'}}}} InputLabelProps={{style: { color: '#fff' }}} onChange={(event) => {
